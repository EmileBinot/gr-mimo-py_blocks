...
class AoA_USRP(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "AoA_USRP")
        ...
        # Blocks
        ##################################################
        self._phase_range = Range(0, 6.283, 0.01, 0, 200)
        ...
        self.blocks_phase_shift_0 = blocks.phase_shift(phase, True)
        ...
        self.connect((self.blocks_phase_shift_0, 0), (self.blocks_complex_to_real_1, 0))
        self.connect((self.uhd_usrp_source_0, 1), (self.blocks_complex_to_real_0, 0))
...
def main(top_block_cls=AoA_USRP, options=None):
