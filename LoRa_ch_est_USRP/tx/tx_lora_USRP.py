...
class tx_lora_USRP(gr.top_block):
    ...
    def __init__(self):
        ...
        self.blocks_file_sink_1_0 = blocks.file_sink(gr.sizeof_gr_complex*1, 'USRP_2', False)
        self.blocks_file_sink_1_0.set_unbuffered(False)
        self.blocks_file_sink_1 = blocks.file_sink(gr.sizeof_gr_complex*1, 'USRP_1', False)
        ...
        self.msg_connect((self.zeromq_pull_msg_source_1, 'out'), (self.epy_block_13, 'h_est'))
        ...
        self.connect((self.epy_block_13, 0), (self.blocks_file_sink_1, 0))
        self.connect((self.epy_block_13, 1), (self.blocks_file_sink_1_0, 0))
...
def main(top_block_cls=tx_lora_USRP, options=None):
