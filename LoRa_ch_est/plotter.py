...
loratx = np.fromfile(open("/home/ebinot/Documents/gr-mimo_blocks/LoRa_ch_est/lora_tx"), dtype=np.complex64)
lorarx = np.fromfile(open("/home/ebinot/Documents/gr-mimo_blocks/LoRa_ch_est/lora_rx"), dtype=np.complex64)
lorarx_crop = np.fromfile(open("/home/ebinot/Documents/gr-mimo_blocks/LoRa_ch_est/lora_rx_crop"), dtype=np.complex64)
...
axs[1].specgram(lorarx, NFFT=64, Fs=32, noverlap=8)
